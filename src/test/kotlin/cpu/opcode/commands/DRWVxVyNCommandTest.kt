...
class DRWVxVyNCommandTest {
    ...
    fun `should draw sprite at the specified coordinates`() {
        ...
        assertThat(cpu.display.getPixel(5, 10)).isTrue()  // Bit 0 of 0x90
        assertThat(cpu.display.getPixel(6, 10)).isFalse() // Bit 1 of 0x90
        assertThat(cpu.display.getPixel(7, 10)).isFalse() // Bit 2 of 0x90
        assertThat(cpu.display.getPixel(8, 10)).isTrue()  // Bit 3 of 0x90
        assertThat(cpu.display.getPixel(9, 10)).isFalse() // Bit 4 of 0x90

        // Row 2 (y=11): Pixels at (5,11) and (7,11) should be set
        assertThat(cpu.display.getPixel(5, 11)).isTrue()  // Bit 0 of 0xA0
        assertThat(cpu.display.getPixel(6, 11)).isFalse() // Bit 1 of 0xA0
        assertThat(cpu.display.getPixel(7, 11)).isTrue()  // Bit 2 of 0xA0
        assertThat(cpu.display.getPixel(8, 11)).isFalse() // Bit 3 of 0xA0

        // Row 3 (y=12): Pixels at (5,12), (6,12), (7,12), and (8,12) should be set
        assertThat(cpu.display.getPixel(5, 12)).isTrue()  // Bit 0 of 0xF0
        assertThat(cpu.display.getPixel(6, 12)).isTrue()  // Bit 1 of 0xF0
        assertThat(cpu.display.getPixel(7, 12)).isTrue()  // Bit 2 of 0xF0
        assertThat(cpu.display.getPixel(8, 12)).isTrue()  // Bit 3 of 0xF0
        assertThat(cpu.display.getPixel(9, 12)).isFalse() // Bit 4 of 0xF0
    ...
    fun `should set VF to 1 when collision occurs`() {
        ...
        cpu.display.setPixel(5, 10, true)
        ...
        assertThat(cpu.display.getPixel(5, 10)).isFalse()
    ...
    fun `should wrap sprite at screen edges`() {
        // Given
        val opcode: UShort = 0xD121u // Draw 1-byte sprite at (V1, V2)
        cpu.registers[1].write(63u) // V1 = 63 (X at right edge - assuming 64-width display)
        cpu.registers[2].write(10u) // V2 = 10 (Y coordinate)
        cpu.I.write(0x200u) // I register points to the sprite data in memory
        ...
        assertThat(cpu.display.getPixel(63, 10)).isTrue()
        assertThat(cpu.display.getPixel(0, 10)).isTrue()
    }
}